...
<title>Userupdatesuccessful</title>
<style>
...
%>
<form action="/Students_Online_Trading_Center/UpdateAdminDetails" method="post">
...
<center>
<font color="green"><i><b>Your details are Updated Successfully</b></i></font>
<script>
function logout()
{
