...
<form action="/Students_Online_Trading_Center/AdminRegDetails" method="post">
<center>
<table>
...
If you are Rigistered user then goto <a href="/Students_Online_Trading_Center/AdminLoginPge.jsp">LOGIN </a>
</center>
<script>
function homepage()
{
